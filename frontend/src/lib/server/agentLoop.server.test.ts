...
vi.mock('./tools/marketSummary.tool', () => ({}));
...
vi.mock('./tools/smartAlerts.tool', () => ({}));
vi.mock('./tools/anomalyDetector.tool', () => ({}));
vi.mock('./tools/multiExchange.tool', () => ({}));
vi.mock('./tools/liquidationHeatmap.tool', () => ({}));
vi.mock('./tools/footprint.tool', () => ({}));
vi.mock('./tools/dcaBot.tool', () => ({}));
vi.mock('./tools/gridBot.tool', () => ({}));
vi.mock('./tools/scheduledBriefing.tool', () => ({}));
